window.ARTICLE_DE = {
  ...
  title: "Ästhetische Füllungen",
  category: "Digitales Smile Design",
  metaDescription: "Was ist eine ästhetische Füllung, wann kommt sie zum Einsatz? Farbabstimmung, Formgebung, Politur, mögliche Risiken und Pflege der Komposit-Reparatur.",
  lead: "Muss nur eine Ecke repariert werden – oder gleich die ganze Vorderfläche? Wer an einem Frontzahn eine Absplitterung, eine Verfärbung oder eine alte Füllung bemerkt, steht meist zuerst vor dieser Frage. Die ästhetische Füllung ist eine punktuelle Reparatur für Fälle, in denen das Problem auf einen Bereich begrenzt bleibt. Die Überschriften unten behandeln Einsatzbereich, Ablauf, mögliche Risiken und die Pflege danach.",
  faqs: [
    {
      q: "Was ist eine ästhetische Füllung?",
      a: "Eine ästhetische Füllung ist eine Reparatur mit Kompositkunststoff, der Farbe und Transluzenz des natürlichen Zahns nachbildet. Das Material wird in dünnen Schichten aufgebaut, jede davon mit einer Speziallampe ausgehärtet. Was hier wirklich den Unterschied macht, sind Randgestaltung und Oberflächentextur. Der Begriff ist der <em>Oberbegriff</em> für ästhetische Kompositarbeiten; die einzelnen Methoden darunter werden weiter unten getrennt behandelt."
    },
    {
      q: "Wann kommt eine ästhetische Füllung zum Einsatz?",
