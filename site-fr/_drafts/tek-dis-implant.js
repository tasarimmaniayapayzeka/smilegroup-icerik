window.ARTICLE_FR = {
  ...
  category: "Traitements Implantaires",
  lead: "Une seule dent manquante peut, avec le temps, perturber l'équilibre masticatoire et l'harmonie du sourire. Cette page explique le périmètre de l'implant unitaire, ses étapes, les risques possibles et les soins de suite. Cliquez sur la rubrique qui vous intéresse pour l'ouvrir.",
  faqs: [
    {
      q: "Qu'est-ce qu'un implant unitaire ?",
      a: "Une racine artificielle posée dans l'os de la mâchoire pour remplacer une dent manquante, avec la restauration fixée dessus, forme un remplacement en une seule unité. La vis positionnée dans l'os est le plus souvent en titane ou en alliage de titane ; une option en zircone peut s'envisager dans certains cas. Une restauration fabriquée pour vous est ensuite fixée sur la racine — le plus souvent une fois la cicatrisation achevée, parfois plus tôt dans les cas favorables. Le point fort de la méthode : l'espace se ferme avec une seule unité, sans toucher aux dents saines de part et d'autre. Si plusieurs dents manquent côte à côte, c'est la planification du <a href=\"/fr/hizmet/coklu-dis-koprulu-implant/\">bridge sur implants</a> qui prend le relais."
    },
    {
      q: "Qui peut recevoir un implant unitaire ?",
      a: "Les adultes qui ont perdu une dent par carie, traumatisme ou maladie gingivale peuvent envisager cette méthode. Première condition : la croissance des mâchoires doit être terminée. La zone d'accueil de l'implant doit offrir un volume osseux suffisant et une gencive saine. Si l'os manque, votre praticien peut planifier d'abord une <a href=\"/fr/hizmet/kemik-grefti/\">greffe osseuse</a> — ou un <a href=\"/fr/hizmet/sinus-lifting/\">sinus lift</a> si l'espace se situe à l'arrière du maxillaire. Santé générale, médicaments en cours, habitudes d'hygiène et tabac entrent aussi en ligne de compte. L'indication se décide sur l'examen et les constats du scanner."
    },
    {
      q: "Quelles sont les étapes du traitement ?",
      a: "Le processus commence par un examen intra-oral et une imagerie 3D ; votre praticien étudie à ce stade l'épaisseur osseuse, la position du nerf et la proximité du sinus. Le jour de l'intervention, la zone est anesthésiée localement. Le chirurgien prépare un site unique pour la dent unique et pose la vis implantaire. Dans les semaines qui suivent, la vis fusionne avec l'os — ce processus biologique s'appelle l'ostéo-intégration. La fusion acquise, votre praticien fixe le pilier et prend une empreinte. Les deux dents naturelles voisines servent de référence pour la longueur et la couleur de la restauration. Le prothésiste prépare ensuite la couronne unitaire ; au dernier rendez-vous, votre praticien la pose et contrôle l'occlusion. Un guide chirurgical peut fixer la position de l'implant avant l'intervention."
    },
    {
      q: "Combien de temps cela prend-il ?",
      a: "La pose chirurgicale se termine généralement en une séance. Le calendrier dépend ensuite de la période de fusion : environ deux à trois mois à la mandibule, trois à six mois au maxillaire. Si la densité osseuse suffit et que la vis atteint une stabilité initiale suffisante au moment de la pose, une dent provisoire peut être fixée le jour même selon le protocole d'<a href=\"/fr/hizmet/1-gunde-implant/\">implant immédiat</a> — cette dent provisoire est généralement réglée pour ne recevoir aucune force masticatoire. Vos constats radiologiques et votre vitesse de cicatrisation personnelle déterminent le délai exact."
    },
    {
      q: "Que ressent-on pendant l'intervention ?",
