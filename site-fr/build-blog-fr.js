...
const DE_SLUGS = JSON.parse(fs.readFileSync(path.join(DRAFTS, 'fr-slug-map.json'), 'utf8')).blog;
...
for (const f of files) {
  ...
  try {
    ...
    obj = sandbox.window.BLOG_FR;
    if (!obj) throw new Error('window.BLOG_FR bulunamadı');
  } catch (e) {
...
<script src="../assets/render-blog-fr.js?v=1"></script>
</body>
</html>
`;
