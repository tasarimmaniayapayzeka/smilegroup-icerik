/* Smile Group EN BLOG render engine
...
(function () {
  ...
  band.innerHTML =
    ...
    '<span class="tag">Blog preview · <b>SEO/GEO-ready</b></span></div>';
  ...
  var hero = new Image();
  hero.className = "hero";
  hero.src = "../../site/gorseller/" + A.slug + "-detay-880x500.jpg";
  hero.alt = A.title;
  ...
  if (A.faqs && A.faqs.length) {
    ...
    sss.appendChild(el("h2", null, "Frequently Asked Questions"));
    var wrap = el("div", "acc-wrap");
    pasteHTML += "<h2>Frequently Asked Questions</h2>\n";
  ...
  paste.innerHTML =
    ...
    '<div class="note">1) Paste the HTML below into the blog post as a <b>Custom HTML</b> block (WordPress prints the H1 title itself). ' +
    '2) Add the schemas to the <b>&lt;head&gt;</b> or a schema plugin.</div>';
  ...
  paste.appendChild(buildBlock("Article HTML (body)", pasteHTML.trim(), "240px"));
  ...
  imgs.innerHTML =
    '<div class="row"><span class="lab">Article images</span></div>' +
    '<div class="note">Download both and upload to the WP media library: ' +
    '<b>cover</b> is used on the blog list card / featured image, <b>detail</b> at the top of the article. ' +
    'Click an image to download it.</div>' +
    '<div class="grid" style="display:flex;gap:16px;flex-wrap:wrap;align-items:flex-start">' +
    '<a href="../../site/gorseller/' + A.slug + '-kapak-300x400.jpg" download="' + A.slug + '-cover-300x400.jpg"' +
    ' style="display:inline-block;text-align:center;text-decoration:none">' +
    '<img src="../../site/gorseller/' + A.slug + '-kapak-300x400.jpg" alt="cover" loading="lazy"' +
    ...
    '<a href="../../site/gorseller/' + A.slug + '-detay-880x500.jpg" download="' + A.slug + '-detail-880x500.jpg"' +
    ' style="display:inline-block;text-align:center;text-decoration:none">' +
    '<img src="../../site/gorseller/' + A.slug + '-detay-880x500.jpg" alt="detail" loading="lazy"' +
  ...
  var foot = el("div", "foot",
    "<span>Smile Group · blog preview — internal use.</span>" +
    '<span><a href="index.html">← All articles</a> · <a href="../index.html">Treatment content</a></span>');
